...
//     const response = await axios.get("https://to-do-application-api.onrender.com/todos");
...
//     try {
//       const response = await axios.delete(`https://to-do-application-api.onrender.com/todos/${id}`);
